...
// root, calc, rps, bild, csv

@RestController
public class overallController  implements ErrorController {
	//private overallService hs = new overallService();
	...
	public String showDocFile() throws FileNotFoundException, IOException {
		// var errorPageFile = new ClassPathResource("error.html");
	...
	public void getImage(HttpServletResponse response) throws IOException {
		...
		var imgFile = new ClassPathResource("templates/bildpamig.jpg");
		if (Math.random() < 0.5) {
			imgFile = new ClassPathResource("templates/bildpamig2.jpg");
		}
